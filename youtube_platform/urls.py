...
from .views.auth import login, logout, register, change_password, forgot_password, confirm_email
from .views.entry_point import entry_point
from .views.profile import profile
from .views.modules.count_roi import process_roi
from .views.approve_channel import approve_channel, oauth2callback 
...
urlpatterns = [
    ...
    url(r'^confirm', confirm_email),
    url(r'^approve_channel', approve_channel),
